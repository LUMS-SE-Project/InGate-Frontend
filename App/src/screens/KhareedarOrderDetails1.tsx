            ...
            return(
              <View>
                <View className="shadow-2xl mx-8 rounded-xl bg-gray-100 px-4 h-auto placeholder-slate-900 mt-5 pb-4">
                    ...
                    <View>
                        <Text className="20 text-base font-Questrial mt-2 ml-1">Customer Name</Text>
                        <Text className="text-base font-Questrial mt-2 ml-1">Customer Address</Text>
                        <Text className="text-base font-Questrial mt-2 ml-1">Partial Order</Text>
                        <Text className="text-base font-Questrial mt-2 ml-1">Gender Preference</Text>
                    </View>
